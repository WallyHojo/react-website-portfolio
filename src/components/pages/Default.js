...
function Default() {
  ...
  const {
    ...
    handleMouseEnter,
    handleMouseLeave,
  } = useContext(ThemeContext); //header height hook
      ...
      <main id="main" className="position-relative" role="main">
        <div className="rounded-container rounded-bottom position-relative">
          ...
          <Element
            ...
            style={{ height: `${windowHeight}px`, paddingTop: headerHeight }}
          >
            <About />
          </Element>
        ...
        <div
          className={`social position-fixed flex-column ${
            isScrolled ? "social-scrolled" : ""
          } ${
            isHeaderVisible
              ? "animate__animated animate__fadeInLeftBig"
              : "animate__animated animate__slow animate__fadeOutLeftBig"
          } d-none d-sm-block`}
        >
          <div>
            <a
          ...
          <div>
            <a
              className="position-relative d-inline-block text-center"
              href="https://dribbble.com/wallyhojo"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
        ...
        <div className="scroll position-fixed flex-column text-uppercase">
          <Link
            to="about-section"
            className={`position-absolute end-0 d-block ${
              isScrolled ? "fade-out" : "fade-in"
            } p-2`}
          >
          ...
          {sectionIDs.map(({ id, label }, index) => (
            <div key={index} className="dot-wrapper position-relative">
              <Link
                ...
                offset={-100}
                duration={500}
                onMouseEnter={(event) => handleMouseEnter(event, label)}
